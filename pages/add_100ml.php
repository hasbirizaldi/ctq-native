    ...
    <div class="col-md-8">
        <div class="card card-primary shadow-lg">
            <div class="card-header">
                <h3 class="card-title">Tambah Data 100ML</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="action/add_100ml.php" method="post">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cav7" name="cav7" placeholder="Cavity 7"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="cav8">Cavity 8</label>
                                <input type="text" class="form-control" id="cav8" name="cav8" placeholder="Cavity 8"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="cav9">Cavity 9</label>
                                <input type="text" class="form-control" id="cav9" name="cav9" placeholder="Cavity 9"
                                    required>
                            </div>
                        </div>
                    </div>
